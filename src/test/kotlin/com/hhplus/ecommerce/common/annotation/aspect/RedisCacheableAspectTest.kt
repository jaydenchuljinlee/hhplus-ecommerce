...
import com.hhplus.ecommerce.product.infrastructure.ProductRepository
...
class RedisCacheableAspectTest: IntegrationConfig() {
    ...
    fun testRedisCacheable() {
        ...
        val cache = redissonClient.getBucket<ProductInfoResult>("product:cache:1", TypedJsonJacksonCodec(
            ProductInfoResult::class.java))
